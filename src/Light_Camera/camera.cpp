...
void Camera::setFixePosition(){
    ...
    _matm = glm::mat4(0.998745, -0.035691, -0.035086, 0.000000,
                      0.047031, 0.908997, 0.414137, 0.000000,
                      0.017110, -0.415268, 0.909537, 0.000000,
                      -12.499939, 71.372063, -11942.612305, 1.000000);
    updateCamVectors(_matm);
}
