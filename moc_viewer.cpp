...
#include "src/MainWindow/viewer.h"
...
QT_MOC_LITERAL(1, 7, 14), // "initializeDone"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "Viewer\0initializeDone\0"
};
...
void Viewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->initializeDone(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Viewer::initializeDone)) {
                *result = 0;
                return;
            }
        }
