...
*
* @brief  Directs localy the light with the slant. Compute the light for the shadows only
*
* Input texture :
*     The slant map.
* Output :
...
*
*  SHADER NUMBER 5. (It's the same shader that shadelight.frag (Number 4) but the separation allows to make different computation. )
**/
