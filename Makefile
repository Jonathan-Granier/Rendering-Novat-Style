#############################################################################
# Makefile for building: bin/debug/Rendu-Style-Nova
# Generated by qmake (3.1) (Qt 5.10.0)
# Project:  Rendu-Style-Nova.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Rendu-Style-Nova.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Rendu-Style-Nova1.0.0
DISTDIR = /disc/jgranier/source_code/Rendu-Style-Nova/bin/debug/Rendu-Style-Nova1.0.0
LINK          = g++
LFLAGS        = 
...
Makefile: Rendu-Style-Nova.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/yacc.prf \
		/usr/lib/qt/mkspecs/features/lex.prf \
		Rendu-Style-Nova.pro \
		/usr/lib/libQt5Widgets.prl \
		/usr/lib/libQt5Gui.prl \
		/usr/lib/libQt5Core.prl
	$(QMAKE) -o Makefile Rendu-Style-Nova.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
/usr/lib/qt/mkspecs/features/spec_pre.prf:
/usr/lib/qt/mkspecs/common/unix.conf:
/usr/lib/qt/mkspecs/common/linux.conf:
/usr/lib/qt/mkspecs/common/sanitize.conf:
